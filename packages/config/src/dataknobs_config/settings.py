...
class SettingsManager:
    ...
    def resolve_paths(self, config: dict, type_name: str) -> dict:
        ...
        for attr_pattern in path_attrs:
            ...
            if isinstance(attr_pattern, str) and attr_pattern.startswith('/') and attr_pattern.endswith('/'):
                # Regex pattern
                ...
                if attr_pattern in result:
                    result[attr_pattern] = self._resolve_path(result[attr_pattern], base_path)
        
        return result
    
    def _get_base_path(self, type_name: str) -> Optional[str]:
        """
    ...
    def _resolve_path(self, path: Union[str, Any], base_path: Optional[str]) -> Union[str, Any]:
        """
