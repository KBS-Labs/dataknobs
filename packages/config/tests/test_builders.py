...
import pytest
from dataknobs_config import Config, ConfigurableBase, FactoryBase, ConfigError
...
class TestObjectCaching:
    ...
    def test_clear_all_cache(self):
        ...
        config = Config({
            "cache": [
                {"name": "redis1", "class": "test_builders.MockCache", "host": "host1", "port": 6379},
                {"name": "redis2", "class": "test_builders.MockCache", "host": "host2", "port": 6380}
            ]
        })
