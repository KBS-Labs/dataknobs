...
# The provider-boundary stubs — the sanctioned last-resort mock. Shared with
# the other Bedrock test modules, so they live in a module pytest does not
# collect; importing them from here would be a second import of a collected
# test module, under a second name, running its module-level code twice.
from _bedrock_stubs import (
    _StubBedrockClient,
    _StubBody,
    _StubSession,
    _stub_provider,
