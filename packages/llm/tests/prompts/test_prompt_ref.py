...
class TestPromptRefBasic:
    def test_simple_resolution(self) -> None:
        ...
        result = renderer.render('{{ prompt_ref("greeting") }}', {}, mode=TemplateMode.JINJA2)
    ...
    def test_fragment_with_defaults(self) -> None:
        ...
        result = renderer.render('{{ prompt_ref("greet") }}', {}, mode=TemplateMode.JINJA2)
...
class TestPromptRefRecursive:
    def test_two_level_resolution(self) -> None:
        ...
        result = renderer.render('{{ prompt_ref("outer") }}', {}, mode=TemplateMode.JINJA2)
...
class TestPromptRefCycleDetection:
    def test_direct_self_reference(self) -> None:
        ...
        with pytest.raises(ValueError, match="Circular prompt reference"):
            renderer.render('{{ prompt_ref("loop") }}', {}, mode=TemplateMode.JINJA2)
    ...
    def test_indirect_cycle(self) -> None:
        ...
        with pytest.raises(ValueError, match="Circular prompt reference"):
            renderer.render('{{ prompt_ref("a") }}', {}, mode=TemplateMode.JINJA2)
...
class TestPromptRefMissingKey:
    def test_missing_key_returns_empty(self) -> None:
        ...
        result = renderer.render('{{ prompt_ref("nonexistent") }}', {}, mode=TemplateMode.JINJA2)
    ...
    def test_no_library_returns_empty(self) -> None:
        ...
        result = renderer.render('{{ prompt_ref("any.key") }}', {}, mode=TemplateMode.JINJA2)
        assert result.content == ""
