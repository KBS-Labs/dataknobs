...
class DatabaseBulkLoader:
    ...
    def load_from_source(
        ...
        sink = DatabaseStreamSink(self.database, table_name=self.table_name, batch_size=batch_size)
    ...
    def export_to_sink(
        ...
        source = DatabaseStreamSource(self.database, query=query, batch_size=batch_size)
