...
class ResultFormatter:
    ...
    def format_single_result(
        context: ExecutionContext, success: bool, result: Any = None, error: Exception | None = None
    ) -> Dict[str, Any]:
    ...
    def format_batch_result(
        context: ExecutionContext, batch_results: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
    ...
    def format_stream_result(
        context: ExecutionContext, chunk_result: Any, chunk_index: int
    ) -> Dict[str, Any]:
    ...
    def format_step_result(
        context: ExecutionContext, new_state: str | None = None, transition_taken: bool = False
    ) -> Dict[str, Any]:
    ...
    def format_error_result(
        context: ExecutionContext, error: Exception, error_state: str | None = None
    ) -> Dict[str, Any]:
    ...
    def format_performance_result(
        context: ExecutionContext, result: Dict[str, Any]
    ) -> Dict[str, Any]:
