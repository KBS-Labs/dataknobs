...
- [x] **Example Implementations** (`examples/`) **[MOSTLY COMPLETE]**
  ...
  - [x] Simple FSM Debugger ✅
    ...
    - [x] Execution tracing ✅
    - [x] Performance profiling ✅
  - [ ] Advanced FSM Debugger ⏳
    - [ ] Step-by-step execution with inspection
    - [ ] Interactive debugging session
    - [ ] Data change tracking
    - [ ] **Note**: Depends on AdvancedFSM improvements (see docs/active/16_ADVANCED_FSM_IMPROVEMENTS.md)
...
**Next Task**: Implement AdvancedFSM improvements to enable full debugging capabilities (see 16_ADVANCED_FSM_IMPROVEMENTS.md for detailed plan)
