...
- `08-architecture-decisions.md` - ADR-011 for detailed decision rationale
- `01.fsm-design.md` - Core design concepts and interfaces
- `07-implementation-status.md` - Implementation status and recent fixes