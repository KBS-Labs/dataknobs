    ...
    "networks": [
        {
            ...
            "states": [
                ...
                {
                    "name": "process",
                    "functions": {"transform": {"type": "registered", "name": "process_action"}},
                },
                {
                    "name": "finalize",
                    "functions": {"transform": {"type": "registered", "name": "finalize_workflow"}},
                },
    ...
    with create_advanced_fsm(
        ...
        for state_name in ["start", "validate"]:
            ...
            for trans in transitions:
                print(
                    f"     → {trans['target']} (has_condition: {trans.get('has_pre_test', False)})"
                )
