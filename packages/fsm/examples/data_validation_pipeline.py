        ...
        if "@" in email:
            ...
            if domain not in allowed_domains:
                validation["errors"].append(
                    f"Domain '{domain}' is not in allowed list: {allowed_domains}"
                )
    ...
    "networks": [
        {
            ...
            "states": [
                ...
                {
                    "name": "normalize",
                    "functions": {"transform": {"type": "registered", "name": "normalize_input"}},
                },
                {
                    "name": "validate_email",
                    "functions": {"transform": {"type": "registered", "name": "validate_email"}},
                },
                {
                    "name": "validate_phone",
                    "functions": {"transform": {"type": "registered", "name": "validate_phone"}},
                },
                {
                    "name": "validate_age",
                    "functions": {"transform": {"type": "registered", "name": "validate_age"}},
                },
                {
                    "name": "summarize",
                    "functions": {
                        "transform": {"type": "registered", "name": "calculate_validation_summary"}
                    },
                },
                {"name": "fully_valid", "is_end": True},
                {"name": "partially_valid", "is_end": True},
                {"name": "invalid", "is_end": True},
            ],
            "arcs": [
...
def main():
    ...
    with SimpleFSM(
        ...
        test_cases = [
            {
                "name": "All Valid",
                "data": {"email": "john.doe@gmail.com", "phone": "(555) 123-4567", "age": 25},
            },
            {
                "name": "Invalid Email Domain",
                "data": {"email": "user@invalid.com", "phone": "5551234567", "age": 30},
            },
            {
                "name": "Invalid Phone",
                "data": {"email": "user@yahoo.com", "phone": "123", "age": 22},
            },
            {
                "name": "Underage",
                "data": {"email": "teen@gmail.com", "phone": "5551234567", "age": 16},
            },
            {
                "name": "Multiple Issues",
                "data": {"email": "not-an-email", "phone": "abc", "age": -5},
            },
