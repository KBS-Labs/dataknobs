...
class TestFSMExceptionTypes:
    ...
    def test_invalid_configuration_error(self):
        ...
        error = InvalidConfigurationError(
            "Invalid network configuration", {"network": "main", "reason": "no start state"}
        )
    ...
    def test_timeout_error(self):
        """Test TimeoutError."""
        error = TimeoutError(
            "Operation timed out after 30 seconds", {"operation": "database_query", "timeout": 30}
        )
    ...
    def test_concurrency_error(self):
        ...
        error = ConcurrencyError(
            "Maximum concurrent executions reached", {"max": 10, "current": 10, "queue_size": 5}
        )
    ...
    def test_circuit_breaker_error_with_wait_time(self):
        ...
        # Test with wait_time
        error = CircuitBreakerError(wait_time=5.5, details={"failures": 10, "threshold": 5})
    ...
    def test_bulkhead_timeout_error(self):
        ...
        error = BulkheadTimeoutError(
            "Queue timeout after 10 seconds", {"queue_size": 100, "position": 50, "timeout": 10}
        )
    ...
    def test_exception_str_representation(self):
        ...
        test_cases = [
            ...
            (
                StateExecutionError("test_state", "Failed"),
                "State 'test_state' execution failed: Failed",
            ),
