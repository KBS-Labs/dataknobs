...
class TestRegexNormalizationWorkflow:
    ...
    def test_sentence_capitalization(self):
        ...
        try:
            ...
            assert result["success"]
            assert (
                result["data"]["normalized"] == "This sentence. Needs capitalization. At the start."
            )
        finally:
            fsm.close()
...
class TestAdvancedRegexProcessing:
    ...
    def test_duplicate_word_removal(self):
        ...
        try:
            test_cases = [
                (
                    "This this has duplicate duplicate words",
                    "This this has duplicate words",
                ...
                (
                    "test test has duplicate duplicate words",
                    "test has duplicate words",
                ),  # All lowercase
...
class TestRegexTransformsYAML:
    ...
    def test_all_in_one_transforms(self):
        ...
        try:
            test_data = {"text": "Hello World 123! Test message with email@example.com"}
            ...
            test_cases = [
                {
                    ...
                    "check": lambda d: (
                        "[SSN]" in d["ssn_masked"] and "[PHONE]" in d["phone_masked"]
                    ),
                },
                {
        ...
        try:
            test_cases = [
                (
                    ...
                    "The API costs 50 dollars with a 10 percent discount",
                ),
...
class TestRegexPerformance:
    ...
    def test_complex_regex_chaining(self):
        ...
        try:
            result = fsm.process(
                {"text": "This  THIS  has   DUPLICATE duplicate  words!!! And punctuation..."}
            )
            assert result["success"]
