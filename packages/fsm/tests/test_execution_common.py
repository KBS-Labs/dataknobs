...
class TestNetworkSelector:
    ...
    def test_get_current_network_from_stack(self):
        ...
        fsm = Mock()
        fsm.networks = {"network1": Mock(name="network1"), "network2": Mock(name="network2")}
    ...
    def test_get_current_network_intelligent_selection_disabled(self):
        ...
        network = NetworkSelector.get_current_network(
            fsm, context, enable_intelligent_selection=False
        )
    ...
    def test_get_current_network_by_data_mode_batch(self):
        ...
        fsm = Mock()
        fsm.networks = {"batch_network": batch_network, "other_network": other_network}
        del fsm.core_fsm
        fsm.main_network = None
    ...
    def test_get_current_network_by_data_mode_stream(self):
        ...
        fsm = Mock()
        fsm.networks = {"stream_processing": stream_network, "other_network": other_network}
        del fsm.core_fsm
        fsm.main_network = None
...
class TestArcScorer:
    ...
    def test_score_arc_with_resources_available(self):
        ...
        context = Mock()
        context.metadata = {}
        context.resources = {"resource1": resource1, "resource2": resource2}
    ...
    def test_score_arc_with_history(self):
        ...
        context = Mock()
        context.metadata = {"arc_state1_state2_stats": {"success_rate": 0.8}}
        context.resources = {}
    ...
    def test_score_arc_with_load_balancing(self):
        ...
        context = Mock()
        context.metadata = {"arc_state1_state2_usage": 10}
        context.resources = {}
...
class TestTransitionSelector:
    ...
    def test_select_transition_strategy_based_breadth_first(self):
        ...
        result = selector.select_transition(
            [arc1, arc2], context, strategy=TraversalStrategy.BREADTH_FIRST
        )
    ...
    def test_select_transition_strategy_resource_optimized(self):
        ...
        result = selector.select_transition(
            [arc1, arc2], context, strategy=TraversalStrategy.RESOURCE_OPTIMIZED
        )
    ...
    def test_select_transition_strategy_stream_optimized(self):
        ...
        result = selector.select_transition(
            [arc1, arc2], context, strategy=TraversalStrategy.STREAM_OPTIMIZED
        )
    ...
    def test_select_transition_hybrid_mode_with_strategy(self):
        ...
        result = selector.select_transition(
            [arc1, arc2], context, strategy=TraversalStrategy.DEPTH_FIRST
        )
...
class TestExtractMetricsFromContext:
    ...
    def test_extract_arc_usage_metrics(self):
        ...
        assert metrics["arc_usage"] == {"state1_state2": 5, "state2_state3": 3}

    def test_extract_network_warnings(self):
        """Test extracting network selection warnings."""
        context = Mock()
        context.metadata = {"network_selection_warning": "Network not found"}
    ...
    def test_extract_batch_info(self):
        ...
        context = Mock()
        context.metadata = {"batch_info": {"size": 100, "processed": 95}}
    ...
    def test_extract_timing_metrics(self):
        ...
        assert metrics["timing"] == {"state1_execution_time": 1.5, "resource_acquisition_time": 0.3}
