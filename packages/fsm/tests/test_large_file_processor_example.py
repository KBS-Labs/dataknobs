...
class TestLargeFileProcessor:
    ...
    def test_process_jsonl_chunk(self):
        ...
        chunk_data = ['{"id": 1, "value": 10}', '{"id": 2, "value": 20}', '{"id": 3, "value": 30}']
    ...
    def test_process_chunk_with_errors(self):
        ...
        chunk_data = ['{"id": 1, "value": 10}', "invalid json", '{"id": 3, "value": 30}']
        ...
        state = MockState(
            {
                ...
                "processing": {
                    ...
                    "statistics": {"min_value": 0, "max_value": 100, "sum": 5000, "count": 95},
                },
            }
        )
    ...
    def test_update_statistics(self):
        ...
        stats = {"min_value": None, "max_value": None, "sum": 0, "count": 0}
    ...
    def test_fsm_jsonl_processing(self, fsm, temp_jsonl_file):
        ...
        result = fsm.process(
            {"file_reference": str(temp_jsonl_file), "chunk_data": chunks[0] if chunks else []}
        )
    ...
    def test_fsm_csv_processing(self, fsm, temp_csv_file):
        ...
        result = fsm.process(
            {"file_reference": str(temp_csv_file), "chunk_data": chunks[0] if chunks else []}
        )
    ...
    def test_fsm_processing_path(self, fsm, temp_jsonl_file):
        ...
        result = fsm.process({"file_reference": str(temp_jsonl_file), "chunk_data": chunks[0]})

        expected_path = ["start", "initialize", "process_chunks", "aggregate", "success"]
    ...
    def test_reference_mode_benefits(self, fsm, temp_jsonl_file):
        ...
        initial_data = {"file_reference": str(temp_jsonl_file), "chunk_data": chunks[0]}
