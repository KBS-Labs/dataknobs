...
class TestFunctionManager:
    ...
    def test_register_multiple_functions(self):
        ...
        manager = FunctionManager()
        functions = {"sync": sync_transform, "async": async_transform, "test": sync_test}
    ...
    def test_register_builtin_function(self):
        ...
        wrapper = manager.register_function(
            "builtin", sync_transform, source=FunctionSource.BUILTIN
        )
    ...
    def test_resolve_dict_inline(self):
        ...
        manager = FunctionManager()
        reference = {"type": "inline", "code": "data['from_dict'] = True; return data"}
    ...
    def test_list_functions(self):
        ...
        manager.register_function("builtin", sync_test, source=FunctionSource.BUILTIN)
