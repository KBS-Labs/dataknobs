...
class TestContextFactory:
    ...
    def simple_fsm(self):
        ...
        fsm = FSM(
            name="test_fsm", data_mode=ProcessingMode.SINGLE, transaction_mode=TransactionMode.NONE
        )
    ...
    def test_create_context_with_dict_data(self, simple_fsm, resource_manager):
        ...
        context = ContextFactory.create_context(
            fsm=simple_fsm, data=data, resource_manager=resource_manager
        )
    ...
    def test_create_context_with_record_data(self, simple_fsm, resource_manager):
        ...
        context = ContextFactory.create_context(
            fsm=simple_fsm, data=record, resource_manager=resource_manager
        )
    ...
    def test_create_context_with_initial_state(self, simple_fsm, resource_manager):
        ...
        context = ContextFactory.create_context(
            fsm=simple_fsm, data=data, initial_state="process", resource_manager=resource_manager
        )
    ...
    def test_create_batch_context(self, simple_fsm):
        ...
        context = ContextFactory.create_batch_context(
            fsm=simple_fsm, batch_data=batch_data, data_mode=ProcessingMode.BATCH
        )
    ...
    def test_create_batch_context_with_resources(self, simple_fsm):
        ...
        context = ContextFactory.create_batch_context(
            fsm=simple_fsm, batch_data=batch_data, resources=resources
        )
    ...
    def test_create_stream_context(self, simple_fsm):
        ...
        config = StreamConfig(chunk_size=100, buffer_size=1000)
        stream_ctx = StreamContext(config=config)

        context = ContextFactory.create_stream_context(
            fsm=simple_fsm, stream_context=stream_ctx, resources={"stream": {"buffer_size": 1024}}
        )
    ...
    def test_resolve_initial_state_with_no_states(self, resource_manager):
        ...
        empty_fsm = FSM(name="empty_fsm", data_mode=ProcessingMode.SINGLE)

        context = ContextFactory.create_context(
            fsm=empty_fsm, data={"test": "data"}, resource_manager=resource_manager
        )
    ...
    def test_resolve_initial_state_with_multiple_networks(self, resource_manager):
        ...
        context = ContextFactory.create_context(
            fsm=fsm, data={"test": "data"}, resource_manager=resource_manager
        )
    ...
    def test_state_instance_data_copy(self, simple_fsm, resource_manager):
        ...
        context = ContextFactory.create_context(
            fsm=simple_fsm, data=original_data, resource_manager=resource_manager
        )
