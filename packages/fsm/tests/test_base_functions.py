...
class TestExecutionResult:
    ...
    def test_success_result(self):
        ...
        result = ExecutionResult.success_result(data={"key": "value"}, metadata={"time": 100})
    ...
    def test_failure_result(self):
        ...
        result = ExecutionResult.failure_result(
            error="Something went wrong", metadata={"code": 500}
        )
    ...
    def test_direct_construction(self):
        ...
        result = ExecutionResult(success=True, data="test", error=None, metadata={"test": True})
...
class TestExceptions:
    ...
    def test_validation_error(self):
        ...
        error = ValidationError(
            "Validation failed", validation_errors=["Field required", "Invalid format"]
        )
    ...
    def test_state_transition_error(self):
        ...
        with pytest.warns(DeprecationWarning):
            error = StateTransitionError(
                "Cannot transition", from_state="state_a", to_state="state_b"
            )
    ...
    def test_resource_error(self):
        """Test ResourceError."""
        error = ResourceError("Connection failed", resource_name="database", operation="connect")
...
class TestCompositeFunction:
    ...
    def test_initialization(self):
        ...
        composite = CompositeFunction("composite", [sub1, sub2], "Composite function")
...
class TestResourceConfig:
    ...
    def test_resource_config_minimal(self):
        ...
        config = ResourceConfig(name="simple", type="memory", connection_params={})
