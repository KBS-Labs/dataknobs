...
class TestExecutionEngineReal:
    ...
    def conditional_fsm_config(self):
        ...
        return {
            ...
            "arcs": [
                {"from": "start", "to": "check", "name": "begin"},
                {
                    "from": "check",
                    "to": "process_high",
                    "name": "high_value",
    ...
    def test_execution_with_error_handling(self):
        ...
        config = {
            ...
            "arcs": [
                {"from": "start", "to": "validate", "name": "begin"},
                {
                    "from": "validate",
                    "to": "process",
                    "name": "valid",
                ...
                {"from": "process", "to": "success", "name": "complete"},
            ],
        }
            ...
            "arcs": [
                {
                    ...
                    "name": "begin",
                    "transform": {
                        "code": 'import time; time.sleep(0.01); data["processed"] = True; data'
                    },
                },
                {
                    "from": "process",
...
class TestAdvancedExecutionReal:
    ...
    def test_async_execution(self):
        ...
        config = {
            ...
            "arcs": [
                {"from": "start", "to": "async_process", "name": "begin"},
                {
                    "from": "async_process",
                    "to": "end",
                    "name": "complete",
    ...
    def test_execution_timeout(self):
        ...
        config = {
            ...
            "arcs": [
                {"from": "start", "to": "slow_process", "name": "begin"},
                {
                    "from": "slow_process",
                    "to": "end",
                    "name": "complete",
    ...
    def test_state_persistence(self):
        ...
        config = {
            ...
            "arcs": [
                {"from": "start", "to": "accumulate", "name": "begin"},
                {
                    "from": "accumulate",
                    "to": "accumulate",
                    "name": "continue",
...
class TestExecutionMetrics:
    ...
    def test_execution_history(self):
        ...
        config = {
            ...
            "arcs": [
                {"from": "start", "to": "middle", "name": "first"},
                {"from": "middle", "to": "end", "name": "second"},
            ],
        }
    ...
    def test_execution_performance(self):
        ...
        config = {
            ...
            "arcs": [{"from": "start", "to": "end", "name": "direct"}],
        }
