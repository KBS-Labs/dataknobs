...
class TestDatabaseETLPipeline:
    ...
    def test_extract_data_function(self):
        ...
        state = MockState(
            {
                "etl_metadata": {"source_table": "sales_raw", "batch_size": 10},
        ...
        state = MockState(
            {
                ...
                "etl_metadata": {"batch_id": "batch_001"},
                "statistics": {"records_transformed": 0, "transformation_errors": []},
            }
        )
    ...
    def test_staging_and_commit(self):
        ...
        # Test staging
        state = MockState({"transformed_records": transformed_records})
        ...
        state = MockState(
            {
                ...
                "statistics": {"records_transformed": 2},
            }
        )
    ...
    def test_batch_processing(self, fsm):
        ...
        for i in range(3):
            ...
            summary = result["data"].get("etl_summary", {})
            batch_results.append({"batch": i + 1, "loaded": summary.get("records_loaded", 0)})
    ...
    def test_copy_mode_behavior(self, fsm):
        ...
        result = fsm.process(
            {"source_table": "sales_raw", "target_table": "sales_fact", "batch_size": 5}
        )
    ...
    def test_etl_statistics_tracking(self, fsm):
        ...
        result = fsm.process(
            {"source_table": "sales_raw", "target_table": "sales_fact", "batch_size": 25}
        )
    ...
    def test_error_threshold_calculation(self):
        ...
        error_rate = (
            state.data["statistics"]["records_failed"]
            / state.data["statistics"]["records_extracted"]
        )
