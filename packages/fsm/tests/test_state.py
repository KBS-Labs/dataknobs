...
class TestStateDefinition:
    ...
    def test_basic_creation(self):
        ...
        state = StateDefinition(name="test_state", type=StateType.NORMAL, description="Test state")
    ...
    def test_resource_requirements(self):
        ...
        state = StateDefinition(
            ...
            resource_requirements=[
                ResourceConfig(name="db", type="database", connection_params={"host": "localhost"})
            ],
        )
...
class TestStateIntegration:
    ...
    def test_state_with_transforms(self):
        ...
        definition = StateDefinition(
            name="transform_state", transform_functions=[MockTransformFunction()]
        )
