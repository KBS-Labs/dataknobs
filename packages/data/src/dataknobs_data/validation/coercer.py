...
class Coercer:
    ...
    def coerce(self, value: Any, target_type: type | FieldType) -> ValidationResult:
        ...
        if value is None:
            return ValidationResult.failure(
                None, [f"Cannot coerce None to {self._type_name(target_type)}"]
            )
    ...
    def coerce_many(
        self, values: dict[str, Any], types: dict[str, type | FieldType]
