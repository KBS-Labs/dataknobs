...
def _remove_temp_artifacts(filepath: str) -> None:
    ...
    doing: closing the handle hands the lock to a blocked waiter, and
    removing the name at that moment lets the next acquirer create a
    fresh inode and lock *that*, putting two holders in the section. Two
    things make it correct here and nowhere else:
