...
class SensorDataGenerator:
    ...
    def generate_anomalous_readings(
        self, sensor_id: str, location: str, start_time: datetime, count: int = 20
    ) -> List[SensorReading]:
    ...
    def generate_duplicate_readings(
        self, base_readings: List[SensorReading], duplicate_rate: float = 0.1
    ) -> List[SensorReading]:
    ...
    def generate_out_of_order_readings(
        self, readings: List[SensorReading], disorder_rate: float = 0.1
    ) -> List[SensorReading]:
    ...
    def generate_missing_data_readings(
        self,
        sensor_id: str,
        location: str,
        start_time: datetime,
    ...
    def generate_batch_failure_scenario(
        self, sensor_id: str, location: str, start_time: datetime, count: int = 50
    ) -> Tuple[List[SensorReading], List[int]]:
