...
class TestVectorOptimizer:
    ...
    def test_select_index_type(self):
        ...
        config = VectorOptimizer.select_index_type(
            num_vectors=1000, vector_dim=128, metric=DistanceMetric.COSINE
        )
        assert config["type"] == "flat"

        # Medium dataset - should use IVF
        config = VectorOptimizer.select_index_type(
            num_vectors=100000, vector_dim=256, metric=DistanceMetric.EUCLIDEAN
        )
        ...
        config = VectorOptimizer.select_index_type(
            num_vectors=10000000, vector_dim=512, metric=DistanceMetric.DOT_PRODUCT
        )
...
class TestVectorStoreBenchmark:
    ...
    async def test_benchmark_indexing(self, store):
        ...
        result = await benchmark.benchmark_indexing(num_vectors=100, vector_dim=128, batch_size=10)
    ...
    async def test_benchmark_search(self, store):
        ...
        result = await benchmark.benchmark_search(num_queries=10, k=5, vector_dim=128)
    ...
    async def test_benchmark_update(self, store):
        ...
        result = await benchmark.benchmark_update(num_updates=20, vector_dim=128)
    ...
    async def test_benchmark_concurrent(self, store):
        ...
        result = await benchmark.benchmark_concurrent_operations(
            num_workers=3, operations_per_worker=10, vector_dim=128
        )
...
class TestComparativeBenchmark:
    ...
    async def test_compare_stores(self):
        ...
        # Compare indexing
        results = await comparison.compare_indexing(num_vectors=100, vector_dim=64)
