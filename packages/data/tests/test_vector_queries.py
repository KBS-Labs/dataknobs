...
class TestVectorQuery:
    ...
    def test_vector_query_with_list(self):
        ...
        vq = VectorQuery(vector=vector_list, field_name="vec", k=5, metric="euclidean")
    ...
    def test_vector_query_with_score_threshold(self):
        ...
        vq = VectorQuery(vector=vector, score_threshold=0.8, rerank=True, rerank_k=20)
...
class TestQueryVectorIntegration:
    ...
    def test_query_with_reranking(self):
        ...
        query = Query().similar_to(vector=vector, k=10).with_reranking(rerank_k=30)

        assert query.vector_query.rerank is True
        assert query.vector_query.rerank_k == 30

        # Test default rerank_k (2 * k)
        query2 = Query().similar_to(vector=vector, k=10).with_reranking()
...
class TestComplexQueryVectorSupport:
    ...
    def test_complex_query_with_vector(self):
        ...
        complex_query = ComplexQuery(vector_query=vq, limit_value=10)
    ...
    def test_complex_query_to_simple_with_vector(self):
        ...
        complex_query = ComplexQuery(condition=condition, vector_query=vq, limit_value=5)
    ...
    def test_complex_query_serialization_with_vector(self):
        ...
        original = ComplexQuery(vector_query=VectorQuery(vector=vector, k=15), limit_value=15)
...
class TestQueryBuilderVectorSupport:
    ...
    def test_query_builder_complex_with_vector(self):
        ...
        query = (
            builder.where("type", Operator.EQ, "article")
            .or_(Filter("priority", Operator.GT, 5), Filter("featured", Operator.EQ, True))
...
class TestVectorQueryEdgeCases:
    ...
    def test_vector_query_metadata(self):
        ...
        vq = VectorQuery(vector=vector, metadata={"model": "bert", "version": "1.0"})
    ...
    def test_multiple_vector_operations(self):
        ...
        query = Query().similar_to(vector=vector1, k=5).similar_to(vector=vector2, k=10)
    ...
    def test_hybrid_with_only_text(self):
        ...
        query = Query().hybrid(text_query="search term", text_field="content")
    ...
    def test_hybrid_with_only_vector(self):
        ...
        query = Query().hybrid(vector=vector, vector_field="embedding")
