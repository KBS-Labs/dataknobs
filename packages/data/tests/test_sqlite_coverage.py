...
class TestSQLBase:
    ...
    def test_table_manager(self):
        ...
        manager = SQLTableManager(
            "test_table", schema_name="public", dialect="postgres", param_style="numeric"
        )
        sql = manager.get_create_table_sql()
    ...
    def test_complex_query_not_operator(self):
        ...
        condition = LogicCondition(
            ...
            conditions=[FilterCondition(Filter("status", Operator.EQ, "active"))],
        )
...
class TestSyncSQLiteCoverage:
    ...
    def test_from_config(self):
        ...
        config = {"path": ":memory:", "table": "custom_table", "timeout": 10.0}
    ...
    def test_pragma_settings(self, tmp_path):
        ...
        db = SyncSQLiteDatabase(
            {"path": str(db_path), "journal_mode": "DELETE", "synchronous": "FULL"}
        )
        db.connect()
    ...
    def test_batch_operations_with_errors(self):
        ...
        try:
            ...
            records = [Record(data={"name": f"User{i}"}) for i in range(3)]
...
class TestAsyncSQLiteCoverage:
    ...
    async def test_from_config(self):
        """Test creating database from config."""
        config = {"path": ":memory:", "table": "custom_table", "pool_size": 10}
    ...
    async def test_pragma_settings(self, tmp_path):
        ...
        db = AsyncSQLiteDatabase(
            {"path": str(db_path), "journal_mode": "MEMORY", "synchronous": "OFF"}
        )
        await db.connect()
    ...
    async def test_batch_operations_transaction_rollback(self):
        ...
        try:
            ...
            records = [Record(data={"name": f"User{i}"}) for i in range(5)]
...
class TestSQLiteEdgeCases:
    ...
    def test_complex_json_data(self):
        ...
        try:
            ...
            complex_data = {
                "name": "Test",
                "nested": {"level1": {"level2": {"value": 123, "array": [1, 2, 3]}}},
                "list": ["a", "b", "c"],
                "boolean": True,
                "null": None,
                "number": 3.14,
    ...
    def test_large_batch_operations(self):
        ...
        try:
            ...
            large_batch = [Record(data={"id": i, "value": f"value_{i}"}) for i in range(1000)]
    ...
    def test_metadata_handling(self):
        ...
        try:
            ...
            record = Record(
                data={"name": "test"},
                metadata={"created_by": "user123", "tags": ["important", "urgent"], "version": 1},
            )
