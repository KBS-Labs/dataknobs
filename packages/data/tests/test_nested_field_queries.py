...
class TestNestedFieldQueries:
    ...
    def test_record_get_nested_value(self):
        ...
        record = Record(
            ...
            data={
                "temperature": 25.5,
                "sensor_config": {"interval": 60, "thresholds": {"min": 10, "max": 40}},
            },
            metadata={
                "type": "sensor_reading",
                "location": "room_a",
            ...
            data={
                "device": {
                    "info": {
                        "manufacturer": "ACME",
                        "model": "TH-100",
                        "specs": {"accuracy": 0.1, "range": {"min": -50, "max": 100}},
                    }
                }
            },
            metadata={"deployment": {"site": "factory-1", "building": "A", "floor": 2}},
        )
    ...
    async def test_async_database_nested_queries(self):
        ...
        records = [
            ...
            Record(
                id="async-3", data={"value": 300}, metadata={"type": "config", "source": "sensor_a"}
            ),
        ]
