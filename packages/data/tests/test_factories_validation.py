            ...
            "fields": [
                {
                    ...
                    "type": "STRING",
                    "required": True,
                    "constraints": [{"type": "length", "min": 3, "max": 20}],
                },
                {
                    "name": "age",
                    "type": "INTEGER",
                    "constraints": [{"type": "range", "min": 0, "max": 150}],
                },
            ],
        }
...
class TestMigrationFactories:
    ...
    def test_migration_factory_basic(self):
        ...
        config = {
            ...
            "operations": [
                {"type": "add_field", "field_name": "created_at", "default_value": "2024-01-01"},
                {"type": "rename_field", "old_name": "id", "new_name": "record_id"},
                {"type": "remove_field", "field_name": "temp_field"},
            ],
        }
    ...
    def test_transformer_factory(self):
        ...
        config = {
            "rules": [
                {"type": "rename", "old_name": "old_field", "new_name": "new_field"},
                {"type": "exclude", "fields": ["temp1", "temp2"]},
                {"type": "add", "field_name": "processed", "value": True},
            ]
        }
        ...
        # Test transformation
        record = Record(
            {"old_field": "value", "temp1": "remove1", "temp2": "remove2", "keep": "this"}
        )
...
class TestFactoryIntegration:
    ...
    def test_schema_validation_in_migration(self):
        ...
        transformer = transformer_factory.create(
            rules=[{"type": "add", "field_name": "name", "value": "default_name"}]
        )
