...
class TestElasticsearchIntegration:
    ...
    def test_batch_operations_with_sample_data(self, elasticsearch_test_index, sample_records):
        ...
        for i, record in enumerate(retrieved):
            ...
            actual_metadata = {k: v for k, v in record.metadata.items() if k in expected_metadata}
    ...
    def test_metadata_persistence(self, elasticsearch_test_index):
        ...
        record = Record(
            ...
            metadata={
                ...
                "nested": {"level1": {"level2": {"key": "deeply_nested_value"}}},
        ...
        actual_metadata = {k: v for k, v in retrieved.metadata.items() if k in expected_metadata}
        assert actual_metadata == expected_metadata
...
class TestElasticsearchAsyncIntegration:
    ...
    async def test_async_upsert_batch_inserts_and_overwrites(self, elasticsearch_test_index):
