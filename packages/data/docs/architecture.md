...
- **Dual ID system**: Separates user IDs from storage IDs (see [Record ID Architecture](record-id-architecture.md))
- **Advanced serialization**: Handles complex types including vectors (see [Record Serialization](record-serialization.md))
